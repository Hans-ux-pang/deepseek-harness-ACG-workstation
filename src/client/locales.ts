...
export const zh = {
  ...
  'pane.console': '控制室',
  'pane.globe': '地球旅行',
  'pane.digitalhuman': '数字人',
  'pane.gamedev': '游戏开发师',
  'dh.projectTitle': '数字人',
  'dh.open': '打开',
  'dh.entryHint': '打开数字人窗（形象 + 待机/说话状态 + 朗读）',
  'dh.idle': '待机',
  'dh.thinking': '思考中',
  'dh.talking': '说话',
  'dh.pick': '换形象',
  'dh.pickTitle': '从媒体库选择形象',
  'dh.speakOn': '朗读开',
  'dh.speakOff': '朗读关',
  'dh.speakTitle': '助手回复时朗读（浏览器内置语音，不装本地模型）',
  'dh.speakReady': '朗读已开 · 下一条回复会念出来',
  'dh.unsupported': '当前浏览器不支持语音朗读',
  'dh.blocked': '浏览器拦住了自动朗读 · 点一下「朗读」按钮再试',
  'dh.mic': '语音',
  'dh.micTitle': '语音聊天：点一下说一句（说完自动收工，不会把你旁边的闲聊送进来）',
  'dh.micOn': '聆听中',
  'dh.sttUnsupported': '当前浏览器不支持语音识别（Chrome / Edge 可用）',
  'dh.micDenied': '麦克风权限被拒 · 在地址栏允许后重试',
  'dh.sttFailed': '语音识别启动失败',
  'dh.sendFailed': '发送失败 · 请看右侧对话',
  'dh.voice': '声线',
  'dh.voiceTitle': '切换数字人的声线（音色 + 音高 + 语速）',
  'dh.voiceGroup': '声线',
  'dh.voiceSysGroup': '系统音色',
  'dh.voiceDefault': '默认',
  'dh.voiceSweet': '甜妹',
  'dh.voiceLoli': '萝莉',
  'dh.voiceQueen': '御姐',
  'dh.voiceGentle': '温柔',
  'dh.voiceBroadcast': '播音',
  'dh.voiceDeep': '低音炮',
  'dh.voicePreview': '试听当前声线',
  'dh.voiceSample': '你好呀，我是你的数字人，现在用的是这个声线。',
  'dh.voiceNoSys': '系统里没有中文音色（上面的声线预设仍然可用）',
  'dh.chars': '字',
  'dh.greet': '你好呀，我是你的数字人，我在的，跟我说句话吧。',
  'dh.floatHint': '拖动移动 · 双击复位',
  'dh.floatResize': '拖动调大小',
  'dh.close': '关闭',
  'dh.empty': '还没有形象素材',
  'dh.emptyHint': '到「控制室 → 背景 → 自定义 → 媒体库」导入照片或视频，这里就能选',
  'dh.video': '视频',
  'dh.photo': '照片',
  'dh.builtinGroup': '内置形象',
  'dh.libraryGroup': '媒体库',
  'pane.refresh': '刷新',
  ...
  'console.bgLabel': '背景',
  'console.petLabel': '看板娘',
  'console.petTitle': 'Live2D 看板娘',
  'console.petOff': '关闭时不加载任何外部资源',
  'console.petLoading': '正在从 CDN 加载…',
  'console.petFailed': '加载失败（需联网，可稍后重试）',
  'console.petHint': '悬停唤醒 · 可拖动',
  'console.bgOff': '关闭背景',
  ...
  'console.bgTipA': '背景透明度（100 = 不透明，0 = 全透明，露出后面的壁纸）',
...
export const en = {
  ...
  'pane.globe': 'Globe Travel',
  'pane.digitalhuman': 'Digital human',
  'pane.gamedev': 'Game Dev Studio',
  'dh.projectTitle': 'Digital human',
  'dh.open': 'Open',
  'dh.entryHint': 'Open the digital-human window (avatar + state + voice)',
  'dh.idle': 'Idle',
  'dh.thinking': 'Thinking',
  'dh.talking': 'Speaking',
  'dh.pick': 'Avatar',
  'dh.pickTitle': 'Pick an avatar from the media library',
  'dh.speakOn': 'Voice on',
  'dh.speakOff': 'Voice off',
  'dh.speakTitle': 'Read replies aloud (browser speech, no local model)',
  'dh.speakReady': 'Voice on — the next reply will be read aloud',
  'dh.unsupported': 'This browser has no speech synthesis',
  'dh.blocked': 'The browser blocked auto-speech — click the Voice button once',
  'dh.mic': 'Voice',
  'dh.micTitle': 'Voice chat: click once and speak one sentence (it stops by itself)',
  'dh.micOn': 'Listening',
  'dh.sttUnsupported': 'Speech recognition is unavailable in this browser (Chrome/Edge)',
  'dh.micDenied': 'Microphone denied — allow it in the address bar and retry',
  'dh.sttFailed': 'Speech recognition failed to start',
  'dh.sendFailed': 'Send failed — check the chat pane',
  'dh.voice': 'Timbre',
  'dh.voiceTitle': 'Switch the digital human timbre (voice + pitch + rate)',
  'dh.voiceGroup': 'Timbre',
  'dh.voiceSysGroup': 'System voices',
  'dh.voiceDefault': 'Default',
  'dh.voiceSweet': 'Sweet',
  'dh.voiceLoli': 'Cutie',
  'dh.voiceQueen': 'Queen',
  'dh.voiceGentle': 'Gentle',
  'dh.voiceBroadcast': 'Broadcast',
  'dh.voiceDeep': 'Deep',
  'dh.voicePreview': 'Preview this timbre',
  'dh.voiceSample': 'Hi, I am your digital human, speaking with this timbre.',
  'dh.voiceNoSys': 'No Chinese system voices (the timbres above still work)',
  'dh.chars': ' chars',
  'dh.greet': 'Hi, I am your digital human. Say something to me.',
  'dh.floatHint': 'Drag to move · double-click to reset',
  'dh.floatResize': 'Drag to resize',
  'dh.close': 'Close',
  'dh.empty': 'No avatar media yet',
  'dh.emptyHint': 'Import a photo or video under Console → Background → Custom → Media library',
  'dh.video': 'Video',
  'dh.photo': 'Photo',
  'dh.builtinGroup': 'Built-in',
  'dh.libraryGroup': 'Media library',
  ...
  'console.petLabel': 'Pet',
  'console.petTitle': 'Live2D pet',
  'console.petOff': 'Nothing is fetched while off',
  'console.petLoading': 'Loading from CDN…',
  'console.petFailed': 'Load failed (needs network; retry later)',
  'console.petHint': 'Hover to wake · drag to move',
  'console.bgOff': 'No background',
  ...
  'console.bgTipA': 'Background opacity (100 = opaque, 0 = fully transparent)',
